...
object SmoothScrollingEverywhereMM : ModMenuApi {
    ...
    override fun getConfigScreenFactory(): Function<Screen, out Screen> = Function { parent ->
        ...
        scrolling.addEntry(
                entryBuilder.startEnumSelector("Easing Method", EasingMethod.EasingMethodImpl::class.java, if (easingMethod is EasingMethod.EasingMethodImpl) easingMethod as EasingMethod.EasingMethodImpl else EasingMethod.EasingMethodImpl.QUART)
